## This script recapitulates all the step to make the partial correlation analysis on three variables (ATAC-RNA-K4) on a subset dataset
...
# G - Plot scatter residuals meanprop for ATAC-K4me3 at 6-8h
